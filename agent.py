...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        state = xstr(waypoint) + "," + inputs['light'] + "," + xstr(inputs['left']) + "," +  xstr(inputs['oncoming'])
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning = True, epsilon = 1, alpha =0.008)
    ...
    sim.run(n_test = 100, tolerance = 0.00008)
